...
// Guide Icons
export class Guide__icons extends React.Component {
  static propTypes = {
    /** Tag overload */
...
export class Guide__icons_wrapper extends React.Component {
  static propTypes = {
    /** Tag overload */
    tagName: PropTypes.oneOfType([
      PropTypes.string,
...
// Icon cards
export class Guide__icons_card extends React.Component {
  static propTypes = {
    /** Tag overload */
    tagName: PropTypes.oneOfType([
      PropTypes.string,
